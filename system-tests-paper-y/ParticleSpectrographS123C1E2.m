...
ParticleSpectrum[K1*CD[-b][S123Field[-c,d,-d]]*CD[c][S123Field[a,-a,b]]+K2*CD[-c][S123Field[-b,d,-d]]*CD[c][S123Field[a,-a,b]]+6*K1*CD[-a][S123Field[a,b,c]]*CD[-d][S123Field[-b,-c,d]]+6*K2*CD[-a][S123Field[a,b,c]]*CD[-d][S123Field[-b,-c,d]]-4*K1*CD[c][S123Field[a,-a,b]]*CD[-d][S123Field[-b,-c,d]]-4*K2*CD[c][S123Field[a,-a,b]]*CD[-d][S123Field[-b,-c,d]]-2*K1*CD[-d][S123Field[-a,-b,-c]]*CD[d][S123Field[a,b,c]]-2*K2*CD[-d][S123Field[-a,-b,-c]]*CD[d][S123Field[a,b,c]],TheoryName->"S123C1E2",Method->"Hard",ShowPropagator->True,AspectRatio->Portrait,MaxLaurentDepth->1];
Quit[];