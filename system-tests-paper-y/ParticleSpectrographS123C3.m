...
ParticleSpectrum[M2*S123Field[a,-a,b]*S123Field[-b,c,-c]+K1*CD[-b][S123Field[-c,d,-d]]*CD[c][S123Field[a,-a,b]]+K2*CD[-c][S123Field[-b,d,-d]]*CD[c][S123Field[a,-a,b]]+K3*CD[-a][S123Field[a,b,c]]*CD[-d][S123Field[-b,-c,d]]-(2*K3*CD[c][S123Field[a,-a,b]]*CD[-d][S123Field[-b,-c,d]])/3-(5*K3*CD[-d][S123Field[-a,-b,-c]]*CD[d][S123Field[a,b,c]])/9,TheoryName->"S123C3",Method->"Hard",ShowPropagator->True,AspectRatio->Portrait,MaxLaurentDepth->1];
Quit[];