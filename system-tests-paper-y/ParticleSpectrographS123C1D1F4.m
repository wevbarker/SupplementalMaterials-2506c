...
ParticleSpectrum[K1*CD[-b][S123Field[-c,d,-d]]*CD[c][S123Field[a,-a,b]]-7*K1*CD[-c][S123Field[-b,d,-d]]*CD[c][S123Field[a,-a,b]]-18*K1*CD[-a][S123Field[a,b,c]]*CD[-d][S123Field[-b,-c,d]]+12*K1*CD[c][S123Field[a,-a,b]]*CD[-d][S123Field[-b,-c,d]]+12*K1*CD[-d][S123Field[-a,-b,-c]]*CD[d][S123Field[a,b,c]],TheoryName->"S123C1D1F4",Method->"Hard",ShowPropagator->True,AspectRatio->Portrait,MaxLaurentDepth->1];
Quit[];